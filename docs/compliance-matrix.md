...
| Use AI in runtime | PASS | `src/ai/llm_client.py`, `src/services/validation_engine.py` |
| Structured AI output | PASS | `src/core/models.py::StructuredExtractionModel` |
| Provider fallback | PASS | `src/ai/llm_client.py` provider chain and health cache |
...
| Health check command | PASS | `python src/main.py --health-check` |
| Structured provider diagnostics | PASS | `src/ai/health.py`, `src/main.py` |
